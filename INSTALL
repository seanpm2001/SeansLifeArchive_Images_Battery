...
----
Installing SeansLifeArchive/Images/Battery
----

SeansLifeArchive/Images/Battery currently doesn't require installation, it is just a collection of images and data. It is part of the Seanpm2001 Life Archive project, and for proper "installation" the repository should be placed under /SeansLifeArchive/<yourInstalledVersion>/Resources/Images/

If you want to load the first project language file, you will need to have an Assembly language interpreter/IDE.
...
----
Install instructions file version: 2 (2022, Wednesday, May 11th at 7:51 pm PST)
----
